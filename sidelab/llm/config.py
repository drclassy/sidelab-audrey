...
PROVIDER_REGISTRY: dict[str, dict] = {
    ...
    "gemini": {
        ...
        "models": ("gemini-2.0-flash-001", "gemini-1.5-pro-001", "gemini-1.5-flash-001"),
...
_BACKEND_ALIASES: dict[str, str] = {
    "cloud": "deepseek", "remote": "deepseek", "1": "deepseek",
    "ollama": "local", "2": "local",
    "nim": "nvidia", "3": "nvidia",
    "moonshot": "kimi", "4": "kimi",
    "alibaba": "qwen", "dashscope": "qwen", "5": "qwen",
    "glm": "zhipu", "6": "zhipu",
    "7": "yi",
    "8": "baichuan",
    "qianfan": "ernie", "9": "ernie",
    "ifly": "spark", "iflytek": "spark", "10": "spark",
    "google": "gemini", "vertex": "gemini", "11": "gemini",
}
