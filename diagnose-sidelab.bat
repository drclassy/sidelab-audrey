...
set "OUT_FILE=%OUT_DIR%\sidelab-diagnostic-%STAMP%.txt"
set "VENV_PY=%ROOT%.venv\Scripts\python.exe"

(
echo ================================================
echo SIDELAB Diagnostics
...
echo [DEEPSEEK]
if exist "%ROOT%.env" (
  findstr /B /C:"SIDELAB_DEFAULT_BACKEND=" /C:"DEEPSEEK_BASE_URL=" /C:"DEEPSEEK_MODEL=" /C:"DEEPSEEK_API_KEY=" "%ROOT%.env"
) else (
  echo .env NOT_FOUND
)
echo.
